...
if __name__ == "__main__":
    ...
    # 시간 조정 필요
    schedule.every().day.at("09:05").do(debug_wrapper)
    schedule.every().day.at("11:05").do(debug_wrapper)
    schedule.every().day.at("13:05").do(debug_wrapper)
    schedule.every().day.at("15:05").do(debug_wrapper)
